...
if __name__ == '__main__':
    ...
    mol_file = "CCc1ccc2c(c1)C(=O)N1CC3CNC(CCS)=C3C21"
    # mol_file = 'CC(=C)C(=O)OCCN(C)C'
    lig_pdbqt = "docking/lig.pdbqt"
    ...
    prot_file = 'docking/test_set/GRK4_HUMAN_1_578_0/4yhj_A_rec.pdb'
    prot_dry = 'docking/protein_dry.pdb'
    prot_pqr = 'docking/protein.pqr'
    prot_pdbqt = 'docking/protein.pdbqt'
